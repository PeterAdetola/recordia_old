                ...
                <div class="modal-content">
                    ...
                    <div class="carousel carousel-slider center intro-carousel">
                        ...
                        <div class="carousel-item slide-1">
                            <img src="{{ asset('backend/assets/images/gallery/intro-slide-1.png') }}" alt="" class="responsive-img animated fadeInUp slide-1-img">
                        ...
                        <div class="carousel-item slide-2">
                            <img src="{{ asset('backend/assets/images/gallery/intro-features.png') }}" alt="" class="responsive-img slide-2-img">
                        ...
                        <div class="carousel-item slide-3">
                            <img src="{{ asset('backend/assets/images/gallery/intro-app.png') }}" alt="" class="responsive-img slide-1-img">
