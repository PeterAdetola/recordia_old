  ...
  <nav class="white" role="navigation">
   ...
   viewBox="0 0 101.5 101.5" style="enable-background:new 0 0 101.5 101.5;" xml:space="preserve">
      ...
      <ul id="mobile-demo" class="side-nav">
                    @auth
        <li><a class="red" href="{{ url('/dashboard') }}">Dashboard</a></li>
                    @else
        <li><a class="red" href="{{ route('login') }}">Log in</a></li>

                        @if (Route::has('register'))
        <li><a class="red" href="{{ route('register') }}">Register</a></li>
                        @endif
                    @endauth
      </ul>
            @endif
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <h5 class="header col s12 light">Financial recording for transparency</h5>
        </div>
        <div class="row center">
 ...
 <div class="container">
    <div class="section">
      ...
      <div class="row">
        <div class="col s12 center">
          ...
          <p class="left-align">The main challenge is that the process of getting the invoice prepared has always been hectic and prone to errors. Recordia is meant to automate the process of invoice preparation, getting it ready on request to be sent to the participant’s email or preferably their whatsapp numbers in a pdf format thereby ensuring a transparent invoice preparation. And also, give an on sight analysis of the total amount raised which will be the amount in cash, amount in transfer and total amount pledged waiting for reconciliation.</p>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="center">Grants permission to users based on their varoius roles</p>
          </div>
        </div>
  ...
  <footer class="page-footer grey darken-2">
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          <h5 class="white-text">Developer's Bio</h5>
          <p class="grey-text text-lighten-4">Peter Adetola is a fullstack software engineer of alx software engineering program working on this project and this project is still a work in progress, stay tuned for updates.</p>
        ...
        <div class="col l3 s12">
          ...
          <ul>
            ...
            <li><a class="white-text" href="#!">Features</a></li>
            <li><a class="white-text" href="#!">Developer</a></li>
          </ul>
        </div>
        <div class="col l3 s12">
          <h5 class="white-text">User Access</h5>
    ...
    <div class="footer-copyright grey darken-3">
      <div class="container">
      Made by <a class="grey-text text-lighten-3" href="http://github.com/PeterAdetola">Peter Adetola</a>
      </div>
    </div>
  </footer>
